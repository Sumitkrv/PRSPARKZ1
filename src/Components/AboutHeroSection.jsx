      ...
      >
        <div className="relative w-full px-4 sm:px-6 py-12 sm:py-16 md:py-20">
          ...
          <div className="text-center mb-10 sm:mb-12 md:mb-16">
            <motion.div 
              className="inline-flex items-center gap-1.5 sm:gap-2 px-4 sm:px-5 py-1.5 sm:py-2 rounded-full mb-4 sm:mb-6"
              style={{
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-6 sm:mb-8 leading-tight px-4 sm:px-0">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
            ...
            <div className="space-y-6 sm:space-y-8 relative">
              <div 
                className="text-xl sm:text-2xl font-light italic mb-6 sm:mb-8 border-l-4 pl-4 sm:pl-6 py-3 sm:py-4 rounded-r-lg"
                style={{ 
            ...
            <div className="relative">
              ...
              >
                <div className="aspect-[4/3] flex items-center justify-center p-6 sm:p-8 md:p-10 lg:p-12">
                  <div className="text-center relative z-10">
                    ...
                    >
                      ...
                      <div 
                        ...
                        <Sparkles className="w-10 h-10 sm:w-12 sm:h-12" style={{ color: theme.amethyst }} />
                      </div>
                    </motion.div>
                    ...
                    <p className="font-light text-sm sm:text-base" style={{ color: '#6B7280' }}>
                    ...
                    <div className="mt-6 sm:mt-8 grid grid-cols-3 gap-3 sm:gap-4">
                      {['Strategy', 'Execution', 'Growth'].map((item, i) => (
                        ...
                        >
                          <motion.div 
                            className="w-10 h-10 sm:w-12 sm:h-12 mx-auto rounded-lg flex items-center justify-center mb-1.5 sm:mb-2"
                            style={{
                              border: `1px solid rgba(139,95,191,0.2)`,
                              background: cardGradient,
                              boxShadow: `0 4px 20px rgba(139,95,191,0.1)`
                          ...
                          >
                            {i === 0 && <Target className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: theme.amethyst }} />}
                            {i === 1 && <PenTool className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: theme.amethyst }} />}
                            {i === 2 && <TrendingUp className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: theme.amethyst }} />}
                          </motion.div>
