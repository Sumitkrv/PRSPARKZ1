...
const ModernNavbar = () => {
  ...
  return (
    <>
      <nav ref={menuRef} className={`fixed top-0 w-full z-50 transition-all duration-500 ease-out ${
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative">
          <div className="flex items-center justify-between">
            ...
            <a href="/" className="group cursor-pointer interactive relative focus:outline-none">
            ...
            <div className="hidden lg:flex items-center">
              <a href="#contact" onClick={(e) => handleNavSectionClick(e, 'contact')} 
                 className="group relative overflow-hidden px-6 xl:px-8 py-3 rounded-xl transition-all duration-300 hover:scale-105 interactive cursor-pointer focus:outline-none focus:ring-2 focus:ring-purple-300"
                 style={{
            ...
            <button 
              ...
              style={{
                ...
                border: `1px solid ${theme.silverPurple}`
              }}
        ...
        <div className={`lg:hidden absolute top-full left-0 right-0 transition-all duration-400 z-40 ${
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
                  ...
                  {item.isSection ? (
                    ...
                    >
                      ...
                      <svg className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-all duration-300" 
                           ...
                           style={{ stroke: theme.metallicPurple }}>
            ...
            {/* Mobile CTA Button */}
            <div className="mt-5 pt-5" style={{ borderTop: `1px solid ${theme.lavender}` }}>
              <a 
                href="#contact"
                onClick={(e) => {
      ...
      {/* Floating Navigation Sidebar - Fixed color issues */}
      <div 
